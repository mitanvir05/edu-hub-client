    ...
    <div>
      ...
      <div className="h-screen py-8 ">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-4">My Selected Cart :</h2>
                          ...
                          <tr key={item._id}>
                            ...
                            <td className="py-4">
                              <p className="text-green-800 text-sm">
                                {moment(item.submitted).format("YYYY-MM-DD")}
                              </p>
                            </td>
                            <td className="py-6 flex gap-3">
                              <button
                                onClick={() => handleDelete(item._id)}
                                className="'px-3 py-1 cursor-pointer bg-red-500 rounded-full text-white font-bold"
                              >
                                <MdDelete />
                              </button>
                              <button
                                onClick={() => handlePay(item._id)}
                                className="px-3 py-1 cursor-pointer bg-green-600 rounded-xl text-white font-bold flex items-center"
                              >
