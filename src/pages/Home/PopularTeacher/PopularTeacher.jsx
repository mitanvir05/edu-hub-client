...
const PopularTeacher = () => {
  ...
  return (
    <div className="md:w-[80%] mx-auto my-36">
      <div>
        ...
        <div className="w-[40%] text-center mx-auto my-4 ">
          <p className="text-gray-400 ">
            Meet Our Exceptional Instructors! Learn from the Best and
            Unleash Your Potential in Every Class. Elevate Your Skills with
      ...
      {instructors ? (
        <>
          <div className=" mt-5 grid mb-28 md:grid-cols-2 lg:grid-cols-3 w-[90%] mx-auto">
            {instructors?.map((instructor, i) => (
              <div
                key={i}
                className="flex ml-3 dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 md:px-8 rounded-md"
              >
